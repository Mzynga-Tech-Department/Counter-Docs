...
A treasury address is an ethereum address that is generated by the serber using the mnemonic phrase.It is worth noting that the server does not save the phrase.
